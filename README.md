...
notes:
- any command using a parameter can recive a parameter as a string directly after the command
- any command using a parameter must have the parameter as one consecutive string
